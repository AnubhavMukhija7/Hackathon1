...
form.setAttribute('id', 'addFacilityAddVendorForm');
form.setAttribute('method', 'POST');
form.setAttribute('action', 'http://localhost:3000/vendor/addFacilityAddVendor');
...
heading.innerHTML = 'Add New Facility And Vendor Details';
document.body.appendChild(heading);
form.appendChild(ul);
ul.style.paddingLeft = '0px';
addListElement('text','Facility Name','New Facility Name','FacilityName',1);
addListElement('text','Facility Description','New Facility Description','FacilityDescription',1);
addSelectElement('Facility Type',3,['','B','O'],['--Select--','Benefit','Overhead'],'FacilityType',1);
